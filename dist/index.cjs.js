...
var reactCountup = require('react-countup');
...
var FormattedText = function (_a) {
    ...
    var _c = reactCountup.useCountUp({
        start: 0,
        end: value,
        duration: 1,
        separator: ',',
    ...
    var updateValue = React.useRef(update);
...
var RotatingPancakeIcon = styled__default['default'](Icon$u)(templateObject_3$7 || (templateObject_3$7 = __makeTemplateObject(["\n  position: absolute;\n  top: 0;\n  left: 40px;\n  animation: ", " 3s ease-in-out infinite;\n  transform: translate3d(0, 0, 0);\n"], ["\n  position: absolute;\n  top: 0;\n  left: 40px;\n  animation: ", " 3s ease-in-out infinite;\n  transform: translate3d(0, 0, 0);\n"])), float);
var FloatingPanIcon = styled__default['default'](Icon$v)(templateObject_4$3 || (templateObject_4$3 = __makeTemplateObject(["\n  position: absolute;\n  top: 40px;\n"], ["\n  position: absolute;\n  top: 40px;\n"])));
...
var Welcome = function (_a) {
    ...
    return (React__default['default'].createElement("div", __assign({ className: "content-wrapper" }, props),
        React__default['default'].createElement("div", { className: "content-body" },
            React__default['default'].createElement("main", null,
                React__default['default'].createElement("section", { className: "head-area", id: "head-area", "data-midnight": "white" },
                    React__default['default'].createElement("div", { className: "bg-banner" }),
                    React__default['default'].createElement("div", { className: "head-content container-fluid d-flex" },
                        React__default['default'].createElement("div", { className: "container" },
                            React__default['default'].createElement("div", { className: "banner-wrapper" },
                                React__default['default'].createElement("div", { className: "row align-items-center justify-content-center" },
                                    React__default['default'].createElement("div", { className: "banner-content" },
                                        React__default['default'].createElement("h1", { className: "animated", id: "joinText", "data-animation": "fadeInUpShorter", "data-animation-delay": "1.5s" }, "Welcome to HAPPYSWAP")))),
                            React__default['default'].createElement("div", { className: "clock-counter animated", "data-animation": "fadeInUpShorter", "data-animation-delay": "2.1s" },
                                React__default['default'].createElement("div", { className: "clock ml-0 mt-4" }),
                                React__default['default'].createElement("div", { className: "message" })),
                            React__default['default'].createElement("div", { className: "banner-wrapper" },
                                React__default['default'].createElement("div", { className: "row align-items-center justify-content-center" },
                                    React__default['default'].createElement("h1", { className: "animated h1-roboto", id: "OpenSoon", "data-animation": "fadeInUpShorter", "data-animation-delay": "1.7s" }, "We are opening soon!"))),
                            React__default['default'].createElement("div", { className: "banner-wrapper" },
                                React__default['default'].createElement("div", { className: "row align-items-center" },
                                    React__default['default'].createElement("div", { className: "col-lg-8 col-md-12" },
                                        React__default['default'].createElement("div", { className: "banner-content advantages-list" },
                                            React__default['default'].createElement("div", { className: "h3-advantages-list" }, "Our Key Advantages"),
                                            React__default['default'].createElement("ul", null,
                                                React__default['default'].createElement("li", null,
                                                    React__default['default'].createElement("span", { className: "points" }, "No deposit fees for most vaults")),
                                                React__default['default'].createElement("li", null,
                                                    React__default['default'].createElement("span", { className: "points" }, "Up to 100% fee reward for most token price")),
                                                React__default['default'].createElement("li", null,
                                                    React__default['default'].createElement("span", { className: "points" }, "Competitive yields")),
                                                React__default['default'].createElement("li", null,
                                                    React__default['default'].createElement("span", { className: "points" },
                                                        "CO",
                                                        React__default['default'].createElement("sup", null, "2"),
                                                        " positive service ",
                                                        React__default['default'].createElement("a", { href: "#CO-friendly", className: "read-more" }, "Read more"))),
                                                React__default['default'].createElement("li", null,
                                                    React__default['default'].createElement("span", { className: "points" },
                                                        "Improve yield by stacking NFTs ",
                                                        React__default['default'].createElement("span", { className: "soon" }, "Coming soon")))))),
                                    React__default['default'].createElement("div", { className: "col-lg-4 col-md-12 move-first animated", "data-animation": "zoomIn", "data-animation-delay": "2s" },
                                        React__default['default'].createElement("div", { className: "logo-wrapper ml-5 pl-5 align-items-center" },
                                            React__default['default'].createElement("div", { className: "crypto-logo" },
                                                React__default['default'].createElement("div", { id: "ripple" }),
                                                React__default['default'].createElement("div", { id: "ripple2" }),
                                                React__default['default'].createElement("div", { id: "ripple3" }),
                                                React__default['default'].createElement("img", { src: "/images/logo-big.png", className: "crypto-logo-img rounded mx-auto d-block pulse2", alt: "SWPY" })))))))),
                    React__default['default'].createElement("div", { className: "bg-ripple-animation d-none d-md-block" },
                        React__default['default'].createElement("div", { className: "left-bottom-ripples" }),
                        React__default['default'].createElement("div", { className: "top-right-ripples" }))),
                React__default['default'].createElement("section", { className: "about section-padding", id: "about" },
                    React__default['default'].createElement("div", { className: "container-fluid" },
                        React__default['default'].createElement("div", { className: "container" },
                            React__default['default'].createElement("div", { className: "heading text-center" },
                                React__default['default'].createElement("h6", { className: "sub-title animated", "data-animation": "fadeInUpShorter", "data-animation-delay": "0.2s" }, "What is Crypto ICO"),
                                React__default['default'].createElement("h2", { className: "title animated", "data-animation": "fadeInUpShorter", "data-animation-delay": "0.3s" },
                                    "About ",
                                    React__default['default'].createElement("strong", null, "Crypto ICO")),
                                React__default['default'].createElement("div", { className: "separator animated", "data-animation": "fadeInUpShorter", "data-animation-delay": "0.3s" },
                                    React__default['default'].createElement("span", { className: "large" }),
                                    React__default['default'].createElement("span", { className: "medium" }),
                                    React__default['default'].createElement("span", { className: "small" })),
                                React__default['default'].createElement("p", { className: "content-desc animated", "data-animation": "fadeInUpShorter", "data-animation-delay": "0.4s" },
                                    "Crypto ICO aims to disrupt the cryptotrading industry by lowering the barrier",
                                    React__default['default'].createElement("br", { className: "d-none d-xl-block" }),
                                    " to creating algorithmic trading models.")),
                            React__default['default'].createElement("div", { className: "content-area" },
                                React__default['default'].createElement("div", { className: "row" },
                                    React__default['default'].createElement("div", { className: "col-md-12 col-lg-6 animated", "data-animation": "fadeInLeftShorter", "data-animation-delay": "0.5s" },
                                        React__default['default'].createElement("h4", { className: "title" },
                                            "We built a platform for ",
                                            React__default['default'].createElement("br", { className: "d-none d-xl-block" }),
                                            " The crypto trading Industry"),
                                        React__default['default'].createElement("h6", { className: "pt-4 pb-2" }, "Cryptocurrency exchanges or digital currency exchanges (DCE) are businesses that allow customers to trade cryptocurrencies or digital currencies for other assets."),
                                        React__default['default'].createElement("p", null, "Cryptocurrency exchanges or digital currency exchanges (DCE) are businesses that allow customers to trade cryptocurrencies or digital currencies for other assets"),
                                        React__default['default'].createElement("p", null, "Creators of digital currencies are often independent of the DCEs that trade the currency.[6] In one type of system, digital currency providers (DCP), are businesses that keep and administer accounts.")),
                                    React__default['default'].createElement("div", { className: "col-md-12 col-lg-6 animated", "data-animation": "fadeInRightShorter", "data-animation-delay": "0.5s" },
                                        React__default['default'].createElement("div", { className: "position-relative what-is-crypto-img float-xl-right" },
                                            React__default['default'].createElement("img", { className: "img-fluid", src: "/images/theme-assets/what-is-crypto.png", alt: "What is Crypto?" }),
                                            React__default['default'].createElement("div", { className: "play-video text-center" },
                                                React__default['default'].createElement("a", { href: "#", className: "play rounded-circle btn-gradient-orange btn-glow video-btn", "data-toggle": "modal", "data-src": "https://www.youtube.com/embed/UXAJu3zS4bU", "data-target": "#ico-modal" },
                                                    React__default['default'].createElement("i", { className: "ti-control-play" })),
                                                React__default['default'].createElement("span", { className: "mt-2 d-none d-md-block" }, "How it works"))))))))),
                React__default['default'].createElement("section", { id: "problem-solution", className: "problem-solution section-padding bg-color" },
                    React__default['default'].createElement("div", { className: "container-fluid" },
                        React__default['default'].createElement("div", { className: "container" },
                            React__default['default'].createElement("div", { className: "heading text-center" },
                                React__default['default'].createElement("h6", { className: "sub-title animated", "data-animation": "fadeInUpShorter", "data-animation-delay": "0.2s" }, "Solutions"),
                                React__default['default'].createElement("h2", { className: "title animated", "data-animation": "fadeInUpShorter", "data-animation-delay": "0.3s" },
                                    "Problems & ",
                                    React__default['default'].createElement("strong", null, "Solutions")),
                                React__default['default'].createElement("div", { className: "separator animated", "data-animation": "fadeInUpShorter", "data-animation-delay": "0.3s" },
                                    React__default['default'].createElement("span", { className: "large" }),
                                    React__default['default'].createElement("span", { className: "medium" }),
                                    React__default['default'].createElement("span", { className: "small" })),
                            ...
                            React__default['default'].createElement("div", { className: "problems" },
                                React__default['default'].createElement("div", { className: "row" },
                                    React__default['default'].createElement("div", { className: "col-md-12 col-lg-6" },
                                        React__default['default'].createElement("div", { className: "heading mb-4" },
                                            React__default['default'].createElement("h4", { className: "title animated", "data-animation": "fadeInUpShorter", "data-animation-delay": "0.2s" }, "Problems"),
                                            React__default['default'].createElement("div", { className: "separator animated", "data-animation": "fadeInUpShorter", "data-animation-delay": "0.3s" },
                                                React__default['default'].createElement("span", { className: "large" }),
                                                React__default['default'].createElement("span", { className: "medium" }),
                                                React__default['default'].createElement("span", { className: "small" }))),
                                        React__default['default'].createElement("p", { className: "animated", "data-animation": "fadeInUpShorter", "data-animation-delay": "0.5s" }, "Different pieces of the new Internet are born as building blocks, but there\u2019s no way for them to work together."),
                                        React__default['default'].createElement("p", { className: "animated", "data-animation": "fadeInUpShorter", "data-animation-delay": "0.7s" }, "Even interoperating new technologies with old centralised resources can prove useful in making the paradigm shift from Web 2 to Web 3 happen. Now we own our data, we can prove that we own what we have and have created it on different platforms, but how do we put it together into a whole new cohesive framework.")),
                                    React__default['default'].createElement("div", { className: "col-md-12 col-lg-6 text-center" },
                                        React__default['default'].createElement("img", { src: "/images/theme-assets/problems-graphic.png", className: "problems-img animated", "data-animation": "fadeInUpShorter", "data-animation-delay": "0.6s", alt: "problems-graphic" })))),
                            React__default['default'].createElement("div", { className: "solutions mt-5" },
                                React__default['default'].createElement("div", { className: "row" },
                                    React__default['default'].createElement("div", { className: "col-md-12 col-lg-6 text-center move-lg-first" },
                                        React__default['default'].createElement("img", { src: "/images/theme-assets/solutions-graphic.png", className: "solutions-img animated", "data-animation": "fadeInUpShorter", "data-animation-delay": "0.6s", alt: "problems-graphic" })),
                                    React__default['default'].createElement("div", { className: "col-md-12 col-lg-6 move-first" },
                                        React__default['default'].createElement("div", { className: "heading mb-4" },
                                            React__default['default'].createElement("h4", { className: "title animated", "data-animation": "fadeInUpShorter", "data-animation-delay": "0.2s" }, "Solutions"),
                                            React__default['default'].createElement("div", { className: "separator animated", "data-animation": "fadeInUpShorter", "data-animation-delay": "0.3s" },
                                                React__default['default'].createElement("span", { className: "large" }),
                                                React__default['default'].createElement("span", { className: "medium" }),
                                                React__default['default'].createElement("span", { className: "small" }))),
                                        React__default['default'].createElement("p", { className: "animated", "data-animation": "fadeInUpShorter", "data-animation-delay": "0.5s" }, "Decentralized cryptocurrency is produced by the entire cryptocurrency system collectively, at a rate which is defined when the system is created and which is publicly known."),
                                        React__default['default'].createElement("p", { className: "animated", "data-animation": "fadeInUpShorter", "data-animation-delay": "0.7s" }, "In centralized banking and economic systems such as the Federal Reserve System, corporate boards or governments control the supply of currency by printing units of fiat money or demanding additions to digital banking ledgers."))))))),
                React__default['default'].createElement("section", { id: "whitepaper", className: "whitepaper section-padding bg-color" },
                    React__default['default'].createElement("div", { className: "container-fluid" },
                        React__default['default'].createElement("div", { className: "container" },
                            React__default['default'].createElement("div", { className: "heading text-center" },
                                React__default['default'].createElement("h6", { className: "sub-title animated", "data-animation": "fadeInUpShorter", "data-animation-delay": "0.2s" }, "Whitepaper"),
                                React__default['default'].createElement("h2", { className: "title animated", "data-animation": "fadeInUpShorter", "data-animation-delay": "0.3s" },
                                    React__default['default'].createElement("strong", null, "Documents,"),
                                    " Terms & Conditions"),
                                React__default['default'].createElement("div", { className: "separator animated", "data-animation": "fadeInUpShorter", "data-animation-delay": "0.3s" },
                                    React__default['default'].createElement("span", { className: "large" }),
                                    React__default['default'].createElement("span", { className: "medium" }),
                            ...
                            React__default['default'].createElement("div", { className: "row" },
                                React__default['default'].createElement("div", { className: "col-md-12 col-lg-5" },
                                    React__default['default'].createElement("div", { className: "whitepaper-img" },
                                        React__default['default'].createElement("a", { href: "/doc.html" },
                                            React__default['default'].createElement("img", { className: "img-fluid animated", "data-animation": "fadeInUpShorter", "data-animation-delay": "0.6s", src: "/images/whitepaper.png", alt: "whitepaper" }),
                                            React__default['default'].createElement("div", { className: "title" }, " Some title text"),
                                            React__default['default'].createElement("div", { className: "desc" }, " Description for ico and some more text an more ..")))),
                                React__default['default'].createElement("div", { className: "col-md-12 col-lg-7" },
                                    React__default['default'].createElement("div", { className: "content-area" },
                                        React__default['default'].createElement("h4", { className: "animated", "data-animation": "fadeInUpShorter", "data-animation-delay": "0.5s" }, "Whitepaper"),
                                        React__default['default'].createElement("p", { className: "animated", "data-animation": "fadeInUpShorter", "data-animation-delay": "0.6s" }, "A white paper is an authoritative report or guide that informs readers concisely about a complex issue and presents the issuing body's philosophy on the matter. It is meant to help readers understand an issue, solve a problem, or make a decision."),
                                        React__default['default'].createElement("p", { className: "animated", "data-animation": "fadeInUpShorter", "data-animation-delay": "0.7s" }, "The initial British term concerning a type of government-issued document has proliferated, taking a somewhat new meaning in business. In business, a white paper is closer to a form of marketing presentation, a tool meant to persuade customers and partners and promote a product or viewpoint, White papers may be considered grey literature."),
                                        React__default['default'].createElement("p", { className: "animated", "data-animation": "fadeInUpShorter", "data-animation-delay": "0.8s" }, "Since the early 1990s, the term \"white paper\", or \"whitepaper\", has been applied to documents used as marketing or sales tools in business."))))))),
                React__default['default'].createElement("section", { id: "roadmap", className: "roadmap section-padding bg-color" },
                    React__default['default'].createElement("div", { className: "container-fluid" },
                        React__default['default'].createElement("div", { className: "container" },
                            React__default['default'].createElement("div", { className: "heading text-center" },
                                React__default['default'].createElement("h6", { className: "sub-title animated", "data-animation": "fadeInUpShorter", "data-animation-delay": "0.2s" }, "Roadmap"),
                                React__default['default'].createElement("h2", { className: "title animated", "data-animation": "fadeInUpShorter", "data-animation-delay": "0.3s" },
                                    React__default['default'].createElement("strong", null, "Implementation "),
                                    "Sheet"),
                                React__default['default'].createElement("div", { className: "separator animated", "data-animation": "fadeInUpShorter", "data-animation-delay": "0.3s" },
                                    React__default['default'].createElement("span", { className: "large" }),
                                    React__default['default'].createElement("span", { className: "medium" }),
                            ...
                            React__default['default'].createElement("div", { className: "row animated", "data-animation": "fadeInUpShorter", "data-animation-delay": "0.6s" },
                                React__default['default'].createElement("div", { className: "col-12" },
                                    React__default['default'].createElement("div", { className: "roadmap-container" },
                                        React__default['default'].createElement("div", { className: "swiper-container" },
                                            React__default['default'].createElement("div", { className: "swiper-wrapper timeline" },
                                                React__default['default'].createElement("div", { className: "swiper-slide" },
                                                    React__default['default'].createElement("div", { className: "roadmap-info" },
                                                        React__default['default'].createElement("div", { className: "timestamp completed" },
                                                            React__default['default'].createElement("span", { className: "date" }, "November 2017")),
                                                        React__default['default'].createElement("div", { className: "status completed" },
                                                ...
                                                React__default['default'].createElement("div", { className: "swiper-slide" },
                                                    React__default['default'].createElement("div", { className: "roadmap-info" },
                                                        React__default['default'].createElement("div", { className: "timestamp completed" },
                                                            React__default['default'].createElement("span", { className: "date" }, "January 2018")),
                                                        React__default['default'].createElement("div", { className: "status completed" },
                                                            React__default['default'].createElement("span", null,
                                                                "Technical & strategy ",
                                                                React__default['default'].createElement("br", null),
                                                                "devlopment")))),
                                                React__default['default'].createElement("div", { className: "swiper-slide active" },
                                                    React__default['default'].createElement("div", { className: "roadmap-info" },
                                                        React__default['default'].createElement("div", { className: "timestamp active" },
                                                            React__default['default'].createElement("span", { className: "date" }, "May 2018")),
                                                        React__default['default'].createElement("div", { className: "status active" },
                                                            React__default['default'].createElement("span", null, "Ico Realease"),
                                                            React__default['default'].createElement("span", { className: "live" }, "Live Now")))),
                                                React__default['default'].createElement("div", { className: "swiper-slide" },
                                                    React__default['default'].createElement("div", { className: "roadmap-info" },
                                                        React__default['default'].createElement("div", { className: "timestamp remaining" },
                                                            React__default['default'].createElement("span", { className: "date" }, "August 2018")),
                                                        React__default['default'].createElement("div", { className: "status remaining" },
                                                            React__default['default'].createElement("span", null,
                                                                "Beta version of ",
                                                                React__default['default'].createElement("br", null),
                                                                "Crypto Ico ")))),
                                                React__default['default'].createElement("div", { className: "swiper-slide" },
                                                    React__default['default'].createElement("div", { className: "roadmap-info" },
                                                        React__default['default'].createElement("div", { className: "timestamp remaining" },
                                                            React__default['default'].createElement("span", { className: "date" }, "November 2018")),
                                                        React__default['default'].createElement("div", { className: "status remaining" },
                                                            React__default['default'].createElement("span", null,
                                                ...
                                                React__default['default'].createElement("div", { className: "swiper-slide" },
                                                    React__default['default'].createElement("div", { className: "roadmap-info" },
                                                        React__default['default'].createElement("div", { className: "timestamp remaining" },
                                                            React__default['default'].createElement("span", { className: "date" }, "December 2018")),
                                                        React__default['default'].createElement("div", { className: "status remaining" },
                                                            React__default['default'].createElement("span", null,
                                                                "Mobile apps for ",
                                                                React__default['default'].createElement("br", null),
                                                                "iOS & Android")))))),
                                        React__default['default'].createElement("div", { className: "swiper-control" },
                                            React__default['default'].createElement("span", { className: "prev-slide" }),
                                            React__default['default'].createElement("span", { className: "next-slide" })))))))),
                React__default['default'].createElement("section", { id: "token-distribution", className: "token-distribution section-padding bg-color" },
                    React__default['default'].createElement("div", { className: "container-fluid" },
                        React__default['default'].createElement("div", { className: "container" },
                            React__default['default'].createElement("div", { className: "heading text-center" },
                                React__default['default'].createElement("h6", { className: "sub-title animated", "data-animation": "fadeInUpShorter", "data-animation-delay": "0.2s" }, "Token Distribution"),
                                React__default['default'].createElement("h2", { className: "title animated", "data-animation": "fadeInUpShorter", "data-animation-delay": "0.3s" },
                                    React__default['default'].createElement("strong", null, "Token"),
                                    " Sale Stats"),
                                React__default['default'].createElement("div", { className: "separator animated", "data-animation": "fadeInUpShorter", "data-animation-delay": "0.3s" },
                                    React__default['default'].createElement("span", { className: "large" }),
                                    React__default['default'].createElement("span", { className: "medium" }),
                            ...
                            React__default['default'].createElement("div", { className: "row" },
                                React__default['default'].createElement("div", { className: "col-md-12 col-lg-6 col-xl-6 animated", "data-animation": "fadeInLeftShorter", "data-animation-delay": "0.6s" },
                                    React__default['default'].createElement("div", { className: "token-img" },
                                        React__default['default'].createElement("img", { className: "img-fluid", src: "/images/theme-assets/chart.png", alt: "token-distribution" }))),
                                React__default['default'].createElement("div", { className: "col-md-12 col-lg-6 col-xl-5 offset-xl-1 animated", "data-animation": "fadeInRightShorter", "data-animation-delay": "0.6s" },
                                    React__default['default'].createElement("div", { className: "content-area" },
                                        React__default['default'].createElement("h4", null, "Details"),
                                        React__default['default'].createElement("p", { className: "mt-1" }, "To calculate the number of tokens you\u2019ll receive, you can follow the following formula. Note that this applies to public presale contributions only. If you participated through a syndicate or private presale,"),
                                        React__default['default'].createElement("p", null, "To calculate the number of tokens you\u2019ll receive, you can follow the following formula. Note that this applies to public presale contributions only. If you participated through a syndicate or private presale,"),
                                        React__default['default'].createElement("p", null,
                                            React__default['default'].createElement("span", null, "Symbol:"),
                                            " ",
                                            React__default['default'].createElement("strong", { className: "grey-accent2" }, "SWPY")),
                                        React__default['default'].createElement("p", null,
                                            React__default['default'].createElement("span", null, "Initial Value:"),
                                            " ",
                                            React__default['default'].createElement("strong", { className: "grey-accent2" }, "1 ETH = 3177.38 SPWY")),
                                        React__default['default'].createElement("p", null,
                                            React__default['default'].createElement("span", null, "Type:"),
                                            " ",
                                            React__default['default'].createElement("strong", { className: "grey-accent2" }, "BEP20")))))))),
                React__default['default'].createElement("section", { id: "faq", className: "faq section-padding bg-color" },
                    React__default['default'].createElement("div", { className: "container-fluid" },
                        React__default['default'].createElement("div", { className: "container" },
                            React__default['default'].createElement("div", { className: "heading text-center" },
                                React__default['default'].createElement("h6", { className: "sub-title animated", "data-animation": "fadeInUpShorter", "data-animation-delay": "0.2s" }, "FAQ"),
                                React__default['default'].createElement("h2", { className: "title animated", "data-animation": "fadeInUpShorter", "data-animation-delay": "0.3s" },
                                    "Frequently Asked ",
                                    React__default['default'].createElement("strong", null, "Questions")),
                                React__default['default'].createElement("div", { className: "separator animated", "data-animation": "fadeInUpShorter", "data-animation-delay": "0.3s" },
                                    React__default['default'].createElement("span", { className: "large" }),
                                    React__default['default'].createElement("span", { className: "medium" }),
                                    React__default['default'].createElement("span", { className: "small" })),
                            ...
                            React__default['default'].createElement("div", { className: "row" },
                                React__default['default'].createElement("div", { className: "col" },
                                    React__default['default'].createElement("nav", null,
                                        React__default['default'].createElement("div", { className: "nav nav-pills nav-underline mb-5 animated", "data-animation": "fadeInUpShorter", "data-animation-delay": "0.5s", id: "myTab", role: "tablist" },
                                            React__default['default'].createElement("a", { href: "#general", className: "nav-item nav-link active", id: "general-tab", "data-toggle": "tab", "aria-controls": "general", "aria-selected": "true", role: "tab" }, "General"),
                                            React__default['default'].createElement("a", { href: "#ico", className: "nav-item nav-link", id: "ico-tab", "data-toggle": "tab", "aria-controls": "ico", "aria-selected": "false", role: "tab" }, "Pre-ICO"),
                                            React__default['default'].createElement("a", { href: "#token", className: "nav-item nav-link", id: "token-tab", "data-toggle": "tab", "aria-controls": "token", "aria-selected": "false", role: "tab" }, "Tokens"),
                                            React__default['default'].createElement("a", { href: "#client", className: "nav-item nav-link", id: "client-tab", "data-toggle": "tab", "aria-controls": "client", "aria-selected": "false", role: "tab" }, "Client"),
                                            React__default['default'].createElement("a", { href: "#legal", className: "nav-item nav-link", id: "legal-tab", "data-toggle": "tab", "aria-controls": "legal", "aria-selected": "false", role: "tab" }, "Legal"))),
                                    React__default['default'].createElement("div", { className: "tab-content", id: "myTabContent" },
                                        React__default['default'].createElement("div", { className: "tab-pane fade show active", id: "general", role: "tabpanel", "aria-labelledby": "general-tab" },
                                            React__default['default'].createElement("div", { id: "general-accordion", className: "collapse-icon accordion-icon-rotate" },
                                                React__default['default'].createElement("div", { className: "card animated", "data-animation": "fadeInUpShorter", "data-animation-delay": "0.1s" },
                                                    React__default['default'].createElement("div", { className: "card-header", id: "headingOne" },
                                                        React__default['default'].createElement("h5", { className: "mb-0" },
                                                            React__default['default'].createElement("a", { className: "btn-link", "data-toggle": "collapse", "data-target": "#collapseOne", "aria-expanded": "true", "aria-controls": "collapseOne" },
                                                                React__default['default'].createElement("span", { className: "icon" }),
                                                                "Can I make payments directly from an exchange?"))),
                                                    React__default['default'].createElement("div", { id: "collapseOne", className: "collapse show", "aria-labelledby": "headingOne", "data-parent": "#general-accordion" },
                                                        React__default['default'].createElement("div", { className: "card-body" }, "Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad squid. 3 wolf moon officia aute, non cupidatat skateboard dolor brunch. Food truck quinoa nesciunt laborum eiusmod. Brunch 3 wolf moon tempor, sunt aliqua put a bird on it squid single-origin coffee nulla assumenda shoreditch et. Nihil anim keffiyeh helvetica, craft beer labore wes anderson cred nesciunt sapiente ea proident. Ad vegan excepteur butcher vice lomo. Leggings occaecat craft beer farm-to-table, raw denim aesthetic synth nesciunt you probably haven't heard of them accusamus labore sustainable VHS."))),
                                                React__default['default'].createElement("div", { className: "card animated", "data-animation": "fadeInUpShorter", "data-animation-delay": "0.2s" },
                                                    React__default['default'].createElement("div", { className: "card-header", id: "headingTwo" },
                                                        React__default['default'].createElement("h5", { className: "mb-0" },
                                                            React__default['default'].createElement("a", { className: "btn-link collapsed", "data-toggle": "collapse", "data-target": "#collapseTwo", "aria-expanded": "false", "aria-controls": "collapseTwo" },
                                                                React__default['default'].createElement("span", { className: "icon" }),
                                                                "When will SWPY be listed on exchanges?"))),
                                                    React__default['default'].createElement("div", { id: "collapseTwo", className: "collapse", "aria-labelledby": "headingTwo", "data-parent": "#general-accordion" },
                                                        React__default['default'].createElement("div", { className: "card-body" }, "Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad squid. 3 wolf moon officia aute, non cupidatat skateboard dolor brunch. Food truck quinoa nesciunt laborum eiusmod. Brunch 3 wolf moon tempor, sunt aliqua put a bird on it squid single-origin coffee nulla assumenda shoreditch et. Nihil anim keffiyeh helvetica, craft beer labore wes anderson cred nesciunt sapiente ea proident. Ad vegan excepteur butcher vice lomo. Leggings occaecat craft beer farm-to-table, raw denim aesthetic synth nesciunt you probably haven't heard of them accusamus labore sustainable VHS."))),
                                                React__default['default'].createElement("div", { className: "card animated", "data-animation": "fadeInUpShorter", "data-animation-delay": "0.3s" },
                                                    React__default['default'].createElement("div", { className: "card-header", id: "headingThree" },
                                                        React__default['default'].createElement("h5", { className: "mb-0" },
                                                            React__default['default'].createElement("a", { className: "btn-link collapsed", "data-toggle": "collapse", "data-target": "#collapseThree", "aria-expanded": "false", "aria-controls": "collapseThree" },
                                                                React__default['default'].createElement("span", { className: "icon" }),
                                                                "What is the SWPY Token a smart contract address?"))),
                                                    React__default['default'].createElement("div", { id: "collapseThree", className: "collapse", "aria-labelledby": "headingThree", "data-parent": "#general-accordion" },
                                                        React__default['default'].createElement("div", { className: "card-body" }, "Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad squid. 3 wolf moon officia aute, non cupidatat skateboard dolor brunch. Food truck quinoa nesciunt laborum eiusmod. Brunch 3 wolf moon tempor, sunt aliqua put a bird on it squid single-origin coffee nulla assumenda shoreditch et. Nihil anim keffiyeh helvetica, craft beer labore wes anderson cred nesciunt sapiente ea proident. Ad vegan excepteur butcher vice lomo. Leggings occaecat craft beer farm-to-table, raw denim aesthetic synth nesciunt you probably haven't heard of them accusamus labore sustainable VHS."))),
                                                React__default['default'].createElement("div", { className: "card animated", "data-animation": "fadeInUpShorter", "data-animation-delay": "0.4s" },
                                                    React__default['default'].createElement("div", { className: "card-header", id: "headingFour" },
                                                        React__default['default'].createElement("h5", { className: "mb-0" },
                                                            React__default['default'].createElement("a", { className: "btn-link collapsed", "data-toggle": "collapse", "data-target": "#collapseFour", "aria-expanded": "false", "aria-controls": "collapseFour" },
                                                                React__default['default'].createElement("span", { className: "icon" }),
                                                                "How can I create a crypto-wallet?"))),
                                                    React__default['default'].createElement("div", { id: "collapseFour", className: "collapse", "aria-labelledby": "headingFour", "data-parent": "#general-accordion" },
                                                        React__default['default'].createElement("div", { className: "card-body" }, "Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad squid. 3 wolf moon officia aute, non cupidatat skateboard dolor brunch. Food truck quinoa nesciunt laborum eiusmod. Brunch 3 wolf moon tempor, sunt aliqua put a bird on it squid single-origin coffee nulla assumenda shoreditch et. Nihil anim keffiyeh helvetica, craft beer labore wes anderson cred nesciunt sapiente ea proident. Ad vegan excepteur butcher vice lomo. Leggings occaecat craft beer farm-to-table, raw denim aesthetic synth nesciunt you probably haven't heard of them accusamus labore sustainable VHS."))))),
                                        React__default['default'].createElement("div", { className: "tab-pane fade", id: "ico", role: "tabpanel", "aria-labelledby": "ico-tab" },
                                            React__default['default'].createElement("div", { id: "ico-accordion", className: "collapse-icon accordion-icon-rotate" },
                                                React__default['default'].createElement("div", { className: "card" },
                                                    React__default['default'].createElement("div", { className: "card-header", id: "icoHeadingOne" },
                                                        React__default['default'].createElement("h5", { className: "mb-0" },
                                                            React__default['default'].createElement("a", { className: "btn-link", "data-toggle": "collapse", "data-target": "#icoCollapseOne", "aria-expanded": "true", "aria-controls": "icoCollapseOne" },
                                                                React__default['default'].createElement("span", { className: "icon" }),
                                                                "Pityful a rethoric question ran over her cheek?"))),
                                                    React__default['default'].createElement("div", { id: "icoCollapseOne", className: "collapse show", "aria-labelledby": "icoHeadingOne", "data-parent": "#ico-accordion" },
                                                        React__default['default'].createElement("div", { className: "card-body" }, "Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad squid. 3 wolf moon officia aute, non cupidatat skateboard dolor brunch. Food truck quinoa nesciunt laborum eiusmod. Brunch 3 wolf moon tempor, sunt aliqua put a bird on it squid single-origin coffee nulla assumenda shoreditch et. Nihil anim keffiyeh helvetica, craft beer labore wes anderson cred nesciunt sapiente ea proident. Ad vegan excepteur butcher vice lomo. Leggings occaecat craft beer farm-to-table, raw denim aesthetic synth nesciunt you probably haven't heard of them accusamus labore sustainable VHS."))),
                                                React__default['default'].createElement("div", { className: "card" },
                                                    React__default['default'].createElement("div", { className: "card-header", id: "icoHeadingTwo" },
                                                        React__default['default'].createElement("h5", { className: "mb-0" },
                                                            React__default['default'].createElement("a", { className: "btn-link collapsed", "data-toggle": "collapse", "data-target": "#icoCollapseTwo", "aria-expanded": "false", "aria-controls": "icoCollapseTwo" },
                                                                React__default['default'].createElement("span", { className: "icon" }),
                                                                "Which roasted parts of sentences fly into your mouth?"))),
                                                    React__default['default'].createElement("div", { id: "icoCollapseTwo", className: "collapse", "aria-labelledby": "icoHeadingTwo", "data-parent": "#ico-accordion" },
                                                        React__default['default'].createElement("div", { className: "card-body" }, "Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad squid. 3 wolf moon officia aute, non cupidatat skateboard dolor brunch. Food truck quinoa nesciunt laborum eiusmod. Brunch 3 wolf moon tempor, sunt aliqua put a bird on it squid single-origin coffee nulla assumenda shoreditch et. Nihil anim keffiyeh helvetica, craft beer labore wes anderson cred nesciunt sapiente ea proident. Ad vegan excepteur butcher vice lomo. Leggings occaecat craft beer farm-to-table, raw denim aesthetic synth nesciunt you probably haven't heard of them accusamus labore sustainable VHS."))),
                                                React__default['default'].createElement("div", { className: "card" },
                                                    React__default['default'].createElement("div", { className: "card-header", id: "icoHeadingThree" },
                                                        React__default['default'].createElement("h5", { className: "mb-0" },
                                                            React__default['default'].createElement("a", { className: "btn-link collapsed", "data-toggle": "collapse", "data-target": "#icoCollapseThree", "aria-expanded": "false", "aria-controls": "icoCollapseThree" },
                                                                React__default['default'].createElement("span", { className: "icon" }),
                                                                "Collapsible Group Item #3"))),
                                                    React__default['default'].createElement("div", { id: "icoCollapseThree", className: "collapse", "aria-labelledby": "icoHeadingThree", "data-parent": "#ico-accordion" },
                                                        React__default['default'].createElement("div", { className: "card-body" }, "Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad squid. 3 wolf moon officia aute, non cupidatat skateboard dolor brunch. Food truck quinoa nesciunt laborum eiusmod. Brunch 3 wolf moon tempor, sunt aliqua put a bird on it squid single-origin coffee nulla assumenda shoreditch et. Nihil anim keffiyeh helvetica, craft beer labore wes anderson cred nesciunt sapiente ea proident. Ad vegan excepteur butcher vice lomo. Leggings occaecat craft beer farm-to-table, raw denim aesthetic synth nesciunt you probably haven't heard of them accusamus labore sustainable VHS."))))),
                                        React__default['default'].createElement("div", { className: "tab-pane fade", id: "token", role: "tabpanel", "aria-labelledby": "token-tab" },
                                            React__default['default'].createElement("div", { id: "token-accordion", className: "collapse-icon accordion-icon-rotate" },
                                                React__default['default'].createElement("div", { className: "card" },
                                                    React__default['default'].createElement("div", { className: "card-header", id: "tokenHeadingOne" },
                                                        React__default['default'].createElement("h5", { className: "mb-0" },
                                                            React__default['default'].createElement("a", { className: "btn-link", "data-toggle": "collapse", "data-target": "#tokenCollapseOne", "aria-expanded": "true", "aria-controls": "tokenCollapseOne" },
                                                                React__default['default'].createElement("span", { className: "icon" }),
                                                                "Collapsible Group Item #1"))),
                                                    React__default['default'].createElement("div", { id: "tokenCollapseOne", className: "collapse show", "aria-labelledby": "tokenHeadingOne", "data-parent": "#token-accordion" },
                                                        React__default['default'].createElement("div", { className: "card-body" }, "Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad squid. 3 wolf moon officia aute, non cupidatat skateboard dolor brunch. Food truck quinoa nesciunt laborum eiusmod. Brunch 3 wolf moon tempor, sunt aliqua put a bird on it squid single-origin coffee nulla assumenda shoreditch et. Nihil anim keffiyeh helvetica, craft beer labore wes anderson cred nesciunt sapiente ea proident. Ad vegan excepteur butcher vice lomo. Leggings occaecat craft beer farm-to-table, raw denim aesthetic synth nesciunt you probably haven't heard of them accusamus labore sustainable VHS."))),
                                                React__default['default'].createElement("div", { className: "card" },
                                                    React__default['default'].createElement("div", { className: "card-header", id: "tokenHeadingTwo" },
                                                        React__default['default'].createElement("h5", { className: "mb-0" },
                                                            React__default['default'].createElement("a", { className: "btn-link collapsed", "data-toggle": "collapse", "data-target": "#tokenCollapseTwo", "aria-expanded": "false", "aria-controls": "tokenCollapseTwo" },
                                                                React__default['default'].createElement("span", { className: "icon" }),
                                                                "Collapsible Group Item #2"))),
                                                    React__default['default'].createElement("div", { id: "tokenCollapseTwo", className: "collapse", "aria-labelledby": "tokenHeadingTwo", "data-parent": "#token-accordion" },
                                                        React__default['default'].createElement("div", { className: "card-body" }, "Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad squid. 3 wolf moon officia aute, non cupidatat skateboard dolor brunch. Food truck quinoa nesciunt laborum eiusmod. Brunch 3 wolf moon tempor, sunt aliqua put a bird on it squid single-origin coffee nulla assumenda shoreditch et. Nihil anim keffiyeh helvetica, craft beer labore wes anderson cred nesciunt sapiente ea proident. Ad vegan excepteur butcher vice lomo. Leggings occaecat craft beer farm-to-table, raw denim aesthetic synth nesciunt you probably haven't heard of them accusamus labore sustainable VHS."))),
                                                React__default['default'].createElement("div", { className: "card" },
                                                    React__default['default'].createElement("div", { className: "card-header", id: "tokenHeadingThree" },
                                                        React__default['default'].createElement("h5", { className: "mb-0" },
                                                            React__default['default'].createElement("a", { className: "btn-link collapsed", "data-toggle": "collapse", "data-target": "#tokenCollapseThree", "aria-expanded": "false", "aria-controls": "tokenCollapseThree" },
                                                                React__default['default'].createElement("span", { className: "icon" }),
                                                                "Collapsible Group Item #3"))),
                                                    React__default['default'].createElement("div", { id: "tokenCollapseThree", className: "collapse", "aria-labelledby": "tokenHeadingThree", "data-parent": "#token-accordion" },
                                                        React__default['default'].createElement("div", { className: "card-body" }, "Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad squid. 3 wolf moon officia aute, non cupidatat skateboard dolor brunch. Food truck quinoa nesciunt laborum eiusmod. Brunch 3 wolf moon tempor, sunt aliqua put a bird on it squid single-origin coffee nulla assumenda shoreditch et. Nihil anim keffiyeh helvetica, craft beer labore wes anderson cred nesciunt sapiente ea proident. Ad vegan excepteur butcher vice lomo. Leggings occaecat craft beer farm-to-table, raw denim aesthetic synth nesciunt you probably haven't heard of them accusamus labore sustainable VHS."))))),
                                        React__default['default'].createElement("div", { className: "tab-pane fade", id: "client", role: "tabpanel", "aria-labelledby": "client-tab" },
                                            React__default['default'].createElement("div", { id: "client-accordion", className: "collapse-icon accordion-icon-rotate" },
                                                React__default['default'].createElement("div", { className: "card" },
                                                    React__default['default'].createElement("div", { className: "card-header", id: "clientHeadingOne" },
                                                        React__default['default'].createElement("h5", { className: "mb-0" },
                                                            React__default['default'].createElement("a", { className: "btn-link", "data-toggle": "collapse", "data-target": "#clientCollapseOne", "aria-expanded": "true", "aria-controls": "clientCollapseOne" },
                                                                React__default['default'].createElement("span", { className: "icon" }),
                                                                "Collapsible Group Item #1"))),
                                                    React__default['default'].createElement("div", { id: "clientCollapseOne", className: "collapse show", "aria-labelledby": "clientHeadingOne", "data-parent": "#client-accordion" },
                                                        React__default['default'].createElement("div", { className: "card-body" }, "Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad squid. 3 wolf moon officia aute, non cupidatat skateboard dolor brunch. Food truck quinoa nesciunt laborum eiusmod. Brunch 3 wolf moon tempor, sunt aliqua put a bird on it squid single-origin coffee nulla assumenda shoreditch et. Nihil anim keffiyeh helvetica, craft beer labore wes anderson cred nesciunt sapiente ea proident. Ad vegan excepteur butcher vice lomo. Leggings occaecat craft beer farm-to-table, raw denim aesthetic synth nesciunt you probably haven't heard of them accusamus labore sustainable VHS."))),
                                                React__default['default'].createElement("div", { className: "card" },
                                                    React__default['default'].createElement("div", { className: "card-header", id: "clientHeadingTwo" },
                                                        React__default['default'].createElement("h5", { className: "mb-0" },
                                                            React__default['default'].createElement("a", { className: "btn-link collapsed", "data-toggle": "collapse", "data-target": "#clientCollapseTwo", "aria-expanded": "false", "aria-controls": "clientCollapseTwo" },
                                                                React__default['default'].createElement("span", { className: "icon" }),
                                                                "Collapsible Group Item #2"))),
                                                    React__default['default'].createElement("div", { id: "clientCollapseTwo", className: "collapse", "aria-labelledby": "clientHeadingTwo", "data-parent": "#client-accordion" },
                                                        React__default['default'].createElement("div", { className: "card-body" }, "Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad squid. 3 wolf moon officia aute, non cupidatat skateboard dolor brunch. Food truck quinoa nesciunt laborum eiusmod. Brunch 3 wolf moon tempor, sunt aliqua put a bird on it squid single-origin coffee nulla assumenda shoreditch et. Nihil anim keffiyeh helvetica, craft beer labore wes anderson cred nesciunt sapiente ea proident. Ad vegan excepteur butcher vice lomo. Leggings occaecat craft beer farm-to-table, raw denim aesthetic synth nesciunt you probably haven't heard of them accusamus labore sustainable VHS."))),
                                                React__default['default'].createElement("div", { className: "card" },
                                                    React__default['default'].createElement("div", { className: "card-header", id: "clientHeadingThree" },
                                                        React__default['default'].createElement("h5", { className: "mb-0" },
                                                            React__default['default'].createElement("a", { className: "btn-link collapsed", "data-toggle": "collapse", "data-target": "#clientCollapseThree", "aria-expanded": "false", "aria-controls": "clientCollapseThree" },
                                                                React__default['default'].createElement("span", { className: "icon" }),
                                                                "Collapsible Group Item #3"))),
                                                    React__default['default'].createElement("div", { id: "clientCollapseThree", className: "collapse", "aria-labelledby": "clientHeadingThree", "data-parent": "#client-accordion" },
                                                        React__default['default'].createElement("div", { className: "card-body" }, "Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad squid. 3 wolf moon officia aute, non cupidatat skateboard dolor brunch. Food truck quinoa nesciunt laborum eiusmod. Brunch 3 wolf moon tempor, sunt aliqua put a bird on it squid single-origin coffee nulla assumenda shoreditch et. Nihil anim keffiyeh helvetica, craft beer labore wes anderson cred nesciunt sapiente ea proident. Ad vegan excepteur butcher vice lomo. Leggings occaecat craft beer farm-to-table, raw denim aesthetic synth nesciunt you probably haven't heard of them accusamus labore sustainable VHS."))))),
                                        React__default['default'].createElement("div", { className: "tab-pane fade", id: "legal", role: "tabpanel", "aria-labelledby": "legal-tab" },
                                            React__default['default'].createElement("div", { id: "legal-accordion", className: "collapse-icon accordion-icon-rotate" },
                                                React__default['default'].createElement("div", { className: "card" },
                                                    React__default['default'].createElement("div", { className: "card-header", id: "legalHeadingOne" },
                                                        React__default['default'].createElement("h5", { className: "mb-0" },
                                                            React__default['default'].createElement("a", { className: "btn-link", "data-toggle": "collapse", "data-target": "#legalCollapseOne", "aria-expanded": "true", "aria-controls": "legalCollapseOne" },
                                                                React__default['default'].createElement("span", { className: "icon" }),
                                                                "Collapsible Group Item #1"))),
                                                    React__default['default'].createElement("div", { id: "legalCollapseOne", className: "collapse show", "aria-labelledby": "legalHeadingOne", "data-parent": "#legal-accordion" },
                                                        React__default['default'].createElement("div", { className: "card-body" }, "Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad squid. 3 wolf moon officia aute, non cupidatat skateboard dolor brunch. Food truck quinoa nesciunt laborum eiusmod. Brunch 3 wolf moon tempor, sunt aliqua put a bird on it squid single-origin coffee nulla assumenda shoreditch et. Nihil anim keffiyeh helvetica, craft beer labore wes anderson cred nesciunt sapiente ea proident. Ad vegan excepteur butcher vice lomo. Leggings occaecat craft beer farm-to-table, raw denim aesthetic synth nesciunt you probably haven't heard of them accusamus labore sustainable VHS."))),
                                                React__default['default'].createElement("div", { className: "card" },
                                                    React__default['default'].createElement("div", { className: "card-header", id: "legalHeadingTwo" },
                                                        React__default['default'].createElement("h5", { className: "mb-0" },
                                                            React__default['default'].createElement("a", { className: "btn-link collapsed", "data-toggle": "collapse", "data-target": "#legalCollapseTwo", "aria-expanded": "false", "aria-controls": "legalCollapseTwo" },
                                                                React__default['default'].createElement("span", { className: "icon" }),
                                                                "Collapsible Group Item #2"))),
                                                    React__default['default'].createElement("div", { id: "legalCollapseTwo", className: "collapse", "aria-labelledby": "legalHeadingTwo", "data-parent": "#legal-accordion" },
                                                        React__default['default'].createElement("div", { className: "card-body" }, "Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad squid. 3 wolf moon officia aute, non cupidatat skateboard dolor brunch. Food truck quinoa nesciunt laborum eiusmod. Brunch 3 wolf moon tempor, sunt aliqua put a bird on it squid single-origin coffee nulla assumenda shoreditch et. Nihil anim keffiyeh helvetica, craft beer labore wes anderson cred nesciunt sapiente ea proident. Ad vegan excepteur butcher vice lomo. Leggings occaecat craft beer farm-to-table, raw denim aesthetic synth nesciunt you probably haven't heard of them accusamus labore sustainable VHS."))),
                                                React__default['default'].createElement("div", { className: "card" },
                                                    React__default['default'].createElement("div", { className: "card-header", id: "legalHeadingThree" },
                                                        React__default['default'].createElement("h5", { className: "mb-0" },
                                                            React__default['default'].createElement("a", { className: "btn-link collapsed", "data-toggle": "collapse", "data-target": "#legalCollapseThree", "aria-expanded": "false", "aria-controls": "legalCollapseThree" },
                                                                React__default['default'].createElement("span", { className: "icon" }),
                                                                "Collapsible Group Item #3"))),
                                                    React__default['default'].createElement("div", { id: "legalCollapseThree", className: "collapse", "aria-labelledby": "legalHeadingThree", "data-parent": "#legal-accordion" },
                                                        React__default['default'].createElement("div", { className: "card-body" }, "Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad squid. 3 wolf moon officia aute, non cupidatat skateboard dolor brunch. Food truck quinoa nesciunt laborum eiusmod. Brunch 3 wolf moon tempor, sunt aliqua put a bird on it squid single-origin coffee nulla assumenda shoreditch et. Nihil anim keffiyeh helvetica, craft beer labore wes anderson cred nesciunt sapiente ea proident. Ad vegan excepteur butcher vice lomo. Leggings occaecat craft beer farm-to-table, raw denim aesthetic synth nesciunt you probably haven't heard of them accusamus labore sustainable VHS."))))))))))),
                React__default['default'].createElement("section", { id: "contact", className: "contact section-padding bg-color" },
                    React__default['default'].createElement("div", { className: "container-fluid" },
                        React__default['default'].createElement("div", { className: "container" },
                            React__default['default'].createElement("div", { className: "heading text-center" },
                                React__default['default'].createElement("h6", { className: "sub-title animated", "data-animation": "fadeInUpShorter", "data-animation-delay": "0.2s" }, "Contact"),
                                React__default['default'].createElement("h2", { className: "title animated", "data-animation": "fadeInUpShorter", "data-animation-delay": "0.3s" },
                                    "Contact",
                                    React__default['default'].createElement("strong", null, " Crypto ICO")),
                                React__default['default'].createElement("div", { className: "separator animated", "data-animation": "fadeInUpShorter", "data-animation-delay": "0.3s" },
                                    ...
                                    React__default['default'].createElement("span", { className: "medium" }),
                                    React__default['default'].createElement("span", { className: "small" })),
                                React__default['default'].createElement("p", { className: "content-desc animated", "data-animation": "fadeInUpShorter", "data-animation-delay": "0.4s" }, "Have questions? We\u2019re happy to help.")),
                            React__default['default'].createElement("div", { className: "row" },
                                React__default['default'].createElement("div", { className: "col-md-12 col-xl-8 mx-auto" },
                                    React__default['default'].createElement("ul", { className: "list-unstyled contact-info pb-5 mb-5" },
                                        React__default['default'].createElement("li", { className: "animated", "data-animation": "fadeInUpShorter", "data-animation-delay": "0.5s" },
                                            React__default['default'].createElement("i", { className: "ti-headphone" }),
                                            React__default['default'].createElement("span", { className: "ml-1" }, "+44 0123 4567")),
                                        React__default['default'].createElement("li", { className: "animated", "data-animation": "fadeInUpShorter", "data-animation-delay": "0.6s" },
                                            React__default['default'].createElement("i", { className: "ti-email" }),
                                            React__default['default'].createElement("span", { className: "ml-1" }, "info@yourcompany.com")),
                                        React__default['default'].createElement("li", { className: "animated", "data-animation": "fadeInUpShorter", "data-animation-delay": "0.7s" },
                                            React__default['default'].createElement("i", { className: "ti-comment-alt" }),
                                            React__default['default'].createElement("span", { className: "ml-1" }, "Join us on Telegram"))),
                                    React__default['default'].createElement("form", { action: "#", method: "post", acceptCharset: "utf-8", className: "text-center" },
                                        React__default['default'].createElement("input", { type: "text", className: "form-control animated", "data-animation": "fadeInUpShorter", "data-animation-delay": "0.8s", name: "name", placeholder: "Your Name" }),
                                        React__default['default'].createElement("input", { type: "text", className: "form-control animated", "data-animation": "fadeInUpShorter", "data-animation-delay": "0.9s", name: "mail", placeholder: "Your Mail" }),
                                        React__default['default'].createElement("textarea", { rows: 4, className: "form-control animated", "data-animation": "fadeInUpShorter", "data-animation-delay": "1.0s", name: "message", placeholder: "Your Massage" }),
                                        React__default['default'].createElement("button", { type: "submit", className: "btn btn-lg btn-glow btn-gradient-orange btn-round animated", "data-animation": "fadeInUpShorter", "data-animation-delay": "1.1s" }, "Send Message")))))))))));
};
...
var css = "#ec0k8KSO3Pa5_ts {\n    animation: ec0k8KSO3Pa5_ts__ts 3000ms linear infinite normal forwards\n}\n\n@keyframes ec0k8KSO3Pa5_ts__ts {\n    0% {\n        transform: translate(24.981054px, 25.154581px) scale(0.2, 0.2)\n    }\n    20% {\n        transform: translate(24.981054px, 25.154581px) scale(0.2, 0.2)\n    }\n    53.333333% {\n        transform: translate(24.981054px, 25.154581px) scale(1, 1)\n    }\n    100% {\n        transform: translate(24.981054px, 25.154581px) scale(1, 1)\n    }\n}\n\n#ec0k8KSO3Pa5 {\n    animation: ec0k8KSO3Pa5_c_o 3000ms linear infinite normal forwards\n}\n\n@keyframes ec0k8KSO3Pa5_c_o {\n    0% {\n        opacity: 1\n    }\n    20% {\n        opacity: 1\n    }\n    53.333333% {\n        opacity: 0\n    }\n    100% {\n        opacity: 0\n    }\n}\n\n#ec0k8KSO3Pa6_ts {\n    animation: ec0k8KSO3Pa6_ts__ts 3000ms linear infinite normal forwards\n}\n\n@keyframes ec0k8KSO3Pa6_ts__ts {\n    0% {\n        transform: translate(24.981054px, 25.154581px) scale(0.2, 0.2)\n    }\n    26.666667% {\n        transform: translate(24.981054px, 25.154581px) scale(0.2, 0.2)\n    }\n    60% {\n        transform: translate(24.981054px, 25.154581px) scale(1, 1)\n    }\n    100% {\n        transform: translate(24.981054px, 25.154581px) scale(1, 1)\n    }\n}\n\n#ec0k8KSO3Pa6 {\n    animation: ec0k8KSO3Pa6_c_o 3000ms linear infinite normal forwards\n}\n\n@keyframes ec0k8KSO3Pa6_c_o {\n    0% {\n        opacity: 1\n    }\n    26.666667% {\n        opacity: 1\n    }\n    60% {\n        opacity: 0\n    }\n    100% {\n        opacity: 0\n    }\n}\n\n#ec0k8KSO3Pa7_ts {\n    animation: ec0k8KSO3Pa7_ts__ts 3000ms linear infinite normal forwards\n}\n\n@keyframes ec0k8KSO3Pa7_ts__ts {\n    0% {\n        transform: translate(24.981054px, 25.154581px) scale(0.2, 0.2)\n    }\n    33.333333% {\n        transform: translate(24.981054px, 25.154581px) scale(0.2, 0.2)\n    }\n    66.666667% {\n        transform: translate(24.981054px, 25.154581px) scale(1, 1)\n    }\n    100% {\n        transform: translate(24.981054px, 25.154581px) scale(1, 1)\n    }\n}\n\n#ec0k8KSO3Pa7 {\n    animation: ec0k8KSO3Pa7_c_o 3000ms linear infinite normal forwards\n}\n\n@keyframes ec0k8KSO3Pa7_c_o {\n    0% {\n        opacity: 1\n    }\n    33.333333% {\n        opacity: 1\n    }\n    66.666667% {\n        opacity: 0\n    }\n    100% {\n        opacity: 0\n    }\n}\n\n#ec0k8KSO3Pa8_ts {\n    animation: ec0k8KSO3Pa8_ts__ts 3000ms linear infinite normal forwards\n}\n\n@keyframes ec0k8KSO3Pa8_ts__ts {\n    0% {\n        transform: translate(24.988975px, 25.505826px) scale(0.8, 0.8)\n    }\n    43.333333% {\n        transform: translate(24.988975px, 25.505826px) scale(1, 1)\n    }\n    83.333333% {\n        transform: translate(24.988975px, 25.505826px) scale(0.8, 0.8)\n    }\n    100% {\n        transform: translate(24.988975px, 25.505826px) scale(0.8, 0.8)\n    }\n}\n";
n(css,{});

styled__default['default'].text(templateObject_1$d || (templateObject_1$d = __makeTemplateObject(["\n  font-size: 26.26px;\n  font-family: GoodTimingRg-Bold, Good Timing !important;\n  font-weight: 700;\n"], ["\n  font-size: 26.26px;\n  font-family: GoodTimingRg-Bold, Good Timing !important;\n  font-weight: 700;\n"])));
styled__default['default'].tspan(templateObject_2$5 || (templateObject_2$5 = __makeTemplateObject(["\n  font-size: 26.26px;\n  font-family: GoodTimingRg-Bold, Good Timing !important;\n  font-weight: 700;\n  letter-spacing: 0em;\n"], ["\n  font-size: 26.26px;\n  font-family: GoodTimingRg-Bold, Good Timing !important;\n  font-weight: 700;\n  letter-spacing: 0em;\n"])));
var Logo$3 = function (_a) {
    ...
    return (React__default['default'].createElement("svg", { id: "ec0k8KSO3Pa1", width: width, height: height, xmlns: "http://www.w3.org/2000/svg", xmlnsXlink: "http://www.w3.org/1999/xlink", viewBox: "0 0 50 50", shapeRendering: "geometricPrecision", textRendering: "geometricPrecision" },
        React__default['default'].createElement("defs", null,
            React__default['default'].createElement("radialGradient", { id: "ec0k8KSO3Pa4-fill", cx: "0", cy: "0", r: "0.5", spreadMethod: "pad", gradientUnits: "objectBoundingBox", gradientTransform: "matrix(1 0 0 1 0.5 0.5)" },
                React__default['default'].createElement("stop", { id: "ec0k8KSO3Pa4-fill-0", offset: "0%", stopColor: "rgb(254,207,55)" }),
                React__default['default'].createElement("stop", { id: "ec0k8KSO3Pa4-fill-1", offset: "100%", stopColor: "rgb(254,154,52)" })),
            React__default['default'].createElement("filter", { id: "ec0k8KSO3Pa8-filter", x: "-400%", width: "600%", y: "-400%", height: "600%" },
                React__default['default'].createElement("feGaussianBlur", { id: "ec0k8KSO3Pa8-filter-drop-shadow-0-blur", in: "SourceAlpha", stdDeviation: "1.5,1.5" }),
                React__default['default'].createElement("feOffset", { id: "ec0k8KSO3Pa8-filter-drop-shadow-0-offset", dx: "2", dy: "2", result: "tmp" }),
                React__default['default'].createElement("feFlood", { id: "ec0k8KSO3Pa8-filter-drop-shadow-0-flood", floodColor: "rgba(0,0,0,0.5)" }),
                React__default['default'].createElement("feComposite", { id: "ec0k8KSO3Pa8-filter-drop-shadow-0-composite", operator: "in", in2: "tmp" }),
                React__default['default'].createElement("feMerge", { id: "ec0k8KSO3Pa8-filter-drop-shadow-0-merge" },
                    React__default['default'].createElement("feMergeNode", { id: "ec0k8KSO3Pa8-filter-drop-shadow-0-merge-node-1" }),
                    React__default['default'].createElement("feMergeNode", { id: "ec0k8KSO3Pa8-filter-drop-shadow-0-merge-node-2", in: "SourceGraphic" })))),
        React__default['default'].createElement("g", { id: "ec0k8KSO3Pa2" },
            React__default['default'].createElement("ellipse", { id: "ec0k8KSO3Pa3", rx: "24.6244", ry: "24.746", transform: "matrix(1 0 0 1 24.9811 25.1546)", paintOrder: "stroke fill markers", fill: "rgb(255,255,255)", stroke: "none", strokeWidth: "0.227756", strokeLinecap: "round", strokeLinejoin: "round" }),
            React__default['default'].createElement("ellipse", { id: "ec0k8KSO3Pa4", rx: "22.2297", ry: "22.3395", transform: "matrix(1 0 0 1 24.9811 25.1546)", paintOrder: "stroke fill markers", fill: "url(#ec0k8KSO3Pa4-fill)", stroke: "none", strokeWidth: "0.205607", strokeLinecap: "round", strokeLinejoin: "round" }),
            React__default['default'].createElement("g", { id: "ec0k8KSO3Pa5_ts", transform: "translate(24.981054,25.154581) scale(0.2,0.2)" },
                React__default['default'].createElement("ellipse", { id: "ec0k8KSO3Pa5", rx: "22.2297", ry: "22.3395", transform: "translate(0.000046,0.000019)", paintOrder: "stroke fill markers", fill: "rgb(254,207,55)", stroke: "none", strokeWidth: "0.205607", strokeLinecap: "round", strokeLinejoin: "round" })),
            React__default['default'].createElement("g", { id: "ec0k8KSO3Pa6_ts", transform: "translate(24.981054,25.154581) scale(0.2,0.2)" },
                React__default['default'].createElement("ellipse", { id: "ec0k8KSO3Pa6", rx: "22.2297", ry: "22.3395", transform: "translate(0.000046,0.000019)", paintOrder: "stroke fill markers", fill: "rgb(254,207,55)", stroke: "none", strokeWidth: "0.205607", strokeLinecap: "round", strokeLinejoin: "round" })),
            React__default['default'].createElement("g", { id: "ec0k8KSO3Pa7_ts", transform: "translate(24.981054,25.154581) scale(0.2,0.2)" },
                React__default['default'].createElement("ellipse", { id: "ec0k8KSO3Pa7", rx: "22.2297", ry: "22.3395", transform: "translate(0.000046,0.000019)", paintOrder: "stroke fill markers", fill: "rgb(254,207,55)", stroke: "none", strokeWidth: "0.205607", strokeLinecap: "round", strokeLinejoin: "round" })),
            React__default['default'].createElement("g", { id: "ec0k8KSO3Pa8_ts", transform: "translate(24.988975,25.505826) scale(0.8,0.8)" },
                React__default['default'].createElement("path", { id: "ec0k8KSO3Pa8", d: "M12.034678,16.964669L15.766009,20.696002L11.154531,25.307483L7.423198,21.576149ZM25.001377,11.88212L29.637649,16.518394L12.322326,33.833721L7.686052,29.197443ZM25.001377,11.88212L33.76567,20.646412L29.166581,25.245499L20.402288,16.481206ZM37.645761,17.187803L42.282034,21.824078L24.976582,39.129527L20.340309,34.493254ZM20.836162,25.766151L29.588061,34.518054L24.976582,39.129532L16.224678,30.377633ZM38.823422,25.704161L42.554752,29.435492L37.955663,34.034581L34.224333,30.303246Z", transform: "translate(-24.988975,-25.505826)", paintOrder: "stroke fill markers", filter: "url(#ec0k8KSO3Pa8-filter)", fill: "rgb(255,255,255)", stroke: "none", strokeWidth: "0.277819", strokeLinecap: "round", strokeLinejoin: "round" })))));
};
...
var Logo$2 = function (_a) {
    ...
    return (React__default['default'].createElement("svg", { xmlns: "http://www.w3.org/2000/svg", width: width, height: height, viewBox: "0 0 50 50" },
        React__default['default'].createElement("g", { paintOrder: "stroke fill markers" },
            React__default['default'].createElement("ellipse", { cx: "24.981", cy: "25.155", fill: "#fff", rx: "24.624", ry: "24.746" }),
            React__default['default'].createElement("ellipse", { cx: "24.981", cy: "25.155", fill: "#9850fe", rx: "22.23", ry: "22.339" }),
            React__default['default'].createElement("path", { fill: "#fff", d: "M12.035 16.965l3.731 3.731-4.611 4.611-3.732-3.73zM25 11.882l4.637 4.636-17.316 17.316-4.636-4.637zm0 0l8.765 8.764-4.6 4.6-8.764-8.765zm12.645 5.306l4.636 4.636L24.977 39.13l-4.637-4.637zm-16.81 8.578l8.752 8.752-4.611 4.612-8.752-8.752zm17.987-.062l3.732 3.731-4.6 4.6-3.73-3.732z" }))));
};
...
var Logo = function (_a) {
    ...
    var innerLogo = (React__default['default'].createElement(React__default['default'].Fragment, null,
        React__default['default'].createElement(Logo$3, { className: "desktop-icon", isDark: isDark }),
        " ",
        React__default['default'].createElement("div", { className: "logo" },
            React__default['default'].createElement("span", null, "HAPPY"),
            React__default['default'].createElement("span", null, "SWAP"))));
    return (React__default['default'].createElement(Flex, null,
        React__default['default'].createElement(MenuButton, { "aria-label": "Toggle menu", onClick: togglePush, mr: "0px" }, isPushed ? (React__default['default'].createElement(Icon$q, { width: "24px", color: "hamburger" })) : (React__default['default'].createElement(Icon$r, { width: "24px", color: "hamburger" }))),
        isAbsoluteUrl ? (React__default['default'].createElement(StyledLink, { as: "a", href: href, "aria-label": "Happyswap home page" }, innerLogo)) : (React__default['default'].createElement(StyledLink, { to: href, "aria-label": "Happyswap home page" }, innerLogo))));
};
...
var SubMenuContainer = styled__default['default'].div(templateObject_2$3 || (templateObject_2$3 = __makeTemplateObject(["\n  display: flex;\n  flex-direction: column;\n  overflow-y: auto;\n  overflow-x: hidden;\n  height: 100%;\n  margin-bottom: 1em\n"], ["\n  display: flex;\n  flex-direction: column;\n  overflow-y: auto;\n  overflow-x: hidden;\n  height: 100%;\n  margin-bottom: 1em\n"])));
var MenuA = styled__default['default'].a(templateObject_3$2 || (templateObject_3$2 = __makeTemplateObject(["\n  display: flex;\n  flex-direction: row;\n  align-items: center;\n"], ["\n  display: flex;\n  flex-direction: row;\n  align-items: center;\n"])));
    ...
    return (React__default['default'].createElement(Container$1, null, links.map(function (entry) {
        ...
        if (entry.items) {
            ...
            return (React__default['default'].createElement("div", null,
                React__default['default'].createElement(MenuEntry, { key: entry.label, isPushed: isPushed, className: calloutClass },
...
var TokenInfo = styled__default['default'].div(templateObject_4$1 || (templateObject_4$1 = __makeTemplateObject(["\n  padding: 0 24px;\n  margin-bottom: 1px;\n  border-bottom:  ", ";\n  font-family: 'Roboto', Helvetica, Arial, sans-serif;\n  font-size: 12px;\n  font-weight: 400;\n  color: ", ";\n\n  .title {    \n    display: flex;\n    font-weight: 600;\n    justify-content: center;\n    margin: 8px 0 10px;\n  }\n  .row{\n    display: flex;\n    justify-content: space-between;\n    margin-bottom: 10px;\n  }\n  .cap{\n    text-align: left;\n  }\n  .val {\n    text-align: right;\n  }\n  \n"], ["\n  padding: 0 24px;\n  margin-bottom: 1px;\n  border-bottom:  ", ";\n  font-family: 'Roboto', Helvetica, Arial, sans-serif;\n  font-size: 12px;\n  font-weight: 400;\n  color: ", ";\n\n  .title {    \n    display: flex;\n    font-weight: 600;\n    justify-content: center;\n    margin: 8px 0 10px;\n  }\n  .row{\n    display: flex;\n    justify-content: space-between;\n    margin-bottom: 10px;\n  }\n  .cap{\n    text-align: left;\n  }\n  .val {\n    text-align: right;\n  }\n  \n"])), function (_a) {
    var theme = _a.theme;
    return "solid 1px " + theme.colors.menuLightBackground;
}, function (_a) {
    var theme = _a.theme;
    return theme.colors.textSubtle;
});
var PanelFooter = function (_a) {
    ...
    return (React__default['default'].createElement(Container, null,
        React__default['default'].createElement(TokenInfo, null,
            React__default['default'].createElement("div", { className: 'title' }, "Swappies (SWPY) information:"),
...
var CakePrice = function (_a) {
    ...
    return cakePriceUsd ? (React__default['default'].createElement(PriceLink, { href: "https://dex.guru/token/0x0BbFaB36fFC86Ce9de5f5e8C27665D894508b958-bsc", target: "_blank" },
        React__default['default'].createElement(Logo$2, { className: "logo", isDark: true }),
        React__default['default'].createElement(Text, { color: "borderColor", className: "price", bold: true }, "$" + cakePriceUsd.toFixed(3)))) : (React__default['default'].createElement(Skeleton, { width: 80, height: 24 }));
};
...
var PinnedBack = styled__default['default'].div(templateObject_2$1 || (templateObject_2$1 = __makeTemplateObject(["\n  position: fixed;\n  height : 100vh;\n  color : #FFFFFF;\n  z-index : 0;\n  background :         linear-gradient(to right, #A34FFE, #5934FC);\n  position: fixed;\n  width:100%;\n  \n  .d-none {\n    display : none !important;\n  }\n\n  .d-md-block {\n    display : block !important;\n  }\n  \n  .bg-ripple-animation {\n    overflow : hidden;\n    position : absolute;\n    z-index : 1;\n    top : 0;\n    right : 0;\n    left : 0;\n    bottom : 0;\n  }\n  \n  .left-bottom-ripples {\n    margin-bottom : -80vh;\n    margin-left : -80vh;\n    width : 160vh;\n    height : 160vh;\n    position : absolute;\n    left : 0;\n    bottom : 0;\n  }\n  .top-right-ripples {\n  margin-top : -80vh;\n  margin-right : -80vh;\n  width : 160vh;\n  height : 160vh;\n  position : absolute;\n  top : 0;\n  right : 0;\n}\n\n.ripples {\n  width : 100%;\n  height : 100%;\n  text-align : center;\n}\n.ripples:before {\n  content : '';\n  position : absolute;\n  top : 0;\n  left : 0;\n  width : 100%;\n  height : 100%;\n  background : -webkit-radial-gradient(center, ellipse, rgba(182, 225, 235, 0) 0%, rgba(182, 225, 235, 0.05) 40%, rgba(182, 225, 235, 0.4) 100%);\n  background :    -moz-radial-gradient(center, ellipse, rgba(182, 225, 235, 0) 0%, rgba(182, 225, 235, 0.05) 40%, rgba(182, 225, 235, 0.4) 100%);\n  background :      -o-radial-gradient(center, ellipse, rgba(182, 225, 235, 0) 0%, rgba(182, 225, 235, 0.05) 40%, rgba(182, 225, 235, 0.4) 100%);\n  background :         radial-gradient(ellipse at center, rgba(182, 225, 235, 0) 0%, rgba(182, 225, 235, 0.05) 40%, rgba(182, 225, 235, 0.4) 100%);\n  border : 0.5px solid white;\n  border-radius : 50%;\n  opacity : 0;\n  -webkit-transform : scale(1);\n     -moz-transform : scale(1);\n      -ms-transform : scale(1);\n       -o-transform : scale(1);\n          transform : scale(1);\n  -webkit-animation-name : k1;\n     -moz-animation-name : k1;\n       -o-animation-name : k1;\n          animation-name : k1;\n  -webkit-animation-duration : 6s;\n     -moz-animation-duration : 6s;\n       -o-animation-duration : 6s;\n          animation-duration : 6s;\n  -webkit-animation-delay : 0s;\n     -moz-animation-delay : 0s;\n       -o-animation-delay : 0s;\n          animation-delay : 0s;\n  -webkit-animation-iteration-count : infinite;\n     -moz-animation-iteration-count : infinite;\n       -o-animation-iteration-count : infinite;\n          animation-iteration-count : infinite;\n  -webkit-animation-timing-function : linear;\n     -moz-animation-timing-function : linear;\n       -o-animation-timing-function : linear;\n          animation-timing-function : linear;\n}\n.ripples:after {\n  content : '';\n  position : absolute;\n  top : 0;\n  left : 0;\n  width : 100%;\n  height : 100%;\n  background : -webkit-radial-gradient(center, ellipse, rgba(182, 225, 235, 0) 0%, rgba(182, 225, 235, 0.05) 40%, rgba(182, 225, 235, 0.4) 100%);\n  background :    -moz-radial-gradient(center, ellipse, rgba(182, 225, 235, 0) 0%, rgba(182, 225, 235, 0.05) 40%, rgba(182, 225, 235, 0.4) 100%);\n  background :      -o-radial-gradient(center, ellipse, rgba(182, 225, 235, 0) 0%, rgba(182, 225, 235, 0.05) 40%, rgba(182, 225, 235, 0.4) 100%);\n  background :         radial-gradient(ellipse at center, rgba(182, 225, 235, 0) 0%, rgba(182, 225, 235, 0.05) 40%, rgba(182, 225, 235, 0.4) 100%);\n  border : 0.5px solid white;\n  border-radius : 50%;\n  opacity : 0;\n  -webkit-animation-name : k1;\n     -moz-animation-name : k1;\n       -o-animation-name : k1;\n          animation-name : k1;\n  -webkit-animation-duration : 6s;\n     -moz-animation-duration : 6s;\n       -o-animation-duration : 6s;\n          animation-duration : 6s;\n  -webkit-animation-delay : 3s;\n     -moz-animation-delay : 3s;\n       -o-animation-delay : 3s;\n          animation-delay : 3s;\n  -webkit-animation-iteration-count : infinite;\n     -moz-animation-iteration-count : infinite;\n       -o-animation-iteration-count : infinite;\n          animation-iteration-count : infinite;\n  -webkit-animation-timing-function : linear;\n     -moz-animation-timing-function : linear;\n       -o-animation-timing-function : linear;\n          animation-timing-function : linear;\n}\n  \n"], ["\n  position: fixed;\n  height : 100vh;\n  color : #FFFFFF;\n  z-index : 0;\n  background :         linear-gradient(to right, #A34FFE, #5934FC);\n  position: fixed;\n  width:100%;\n  \n  .d-none {\n    display : none !important;\n  }\n\n  .d-md-block {\n    display : block !important;\n  }\n  \n  .bg-ripple-animation {\n    overflow : hidden;\n    position : absolute;\n    z-index : 1;\n    top : 0;\n    right : 0;\n    left : 0;\n    bottom : 0;\n  }\n  \n  .left-bottom-ripples {\n    margin-bottom : -80vh;\n    margin-left : -80vh;\n    width : 160vh;\n    height : 160vh;\n    position : absolute;\n    left : 0;\n    bottom : 0;\n  }\n  .top-right-ripples {\n  margin-top : -80vh;\n  margin-right : -80vh;\n  width : 160vh;\n  height : 160vh;\n  position : absolute;\n  top : 0;\n  right : 0;\n}\n\n.ripples {\n  width : 100%;\n  height : 100%;\n  text-align : center;\n}\n.ripples:before {\n  content : '';\n  position : absolute;\n  top : 0;\n  left : 0;\n  width : 100%;\n  height : 100%;\n  background : -webkit-radial-gradient(center, ellipse, rgba(182, 225, 235, 0) 0%, rgba(182, 225, 235, 0.05) 40%, rgba(182, 225, 235, 0.4) 100%);\n  background :    -moz-radial-gradient(center, ellipse, rgba(182, 225, 235, 0) 0%, rgba(182, 225, 235, 0.05) 40%, rgba(182, 225, 235, 0.4) 100%);\n  background :      -o-radial-gradient(center, ellipse, rgba(182, 225, 235, 0) 0%, rgba(182, 225, 235, 0.05) 40%, rgba(182, 225, 235, 0.4) 100%);\n  background :         radial-gradient(ellipse at center, rgba(182, 225, 235, 0) 0%, rgba(182, 225, 235, 0.05) 40%, rgba(182, 225, 235, 0.4) 100%);\n  border : 0.5px solid white;\n  border-radius : 50%;\n  opacity : 0;\n  -webkit-transform : scale(1);\n     -moz-transform : scale(1);\n      -ms-transform : scale(1);\n       -o-transform : scale(1);\n          transform : scale(1);\n  -webkit-animation-name : k1;\n     -moz-animation-name : k1;\n       -o-animation-name : k1;\n          animation-name : k1;\n  -webkit-animation-duration : 6s;\n     -moz-animation-duration : 6s;\n       -o-animation-duration : 6s;\n          animation-duration : 6s;\n  -webkit-animation-delay : 0s;\n     -moz-animation-delay : 0s;\n       -o-animation-delay : 0s;\n          animation-delay : 0s;\n  -webkit-animation-iteration-count : infinite;\n     -moz-animation-iteration-count : infinite;\n       -o-animation-iteration-count : infinite;\n          animation-iteration-count : infinite;\n  -webkit-animation-timing-function : linear;\n     -moz-animation-timing-function : linear;\n       -o-animation-timing-function : linear;\n          animation-timing-function : linear;\n}\n.ripples:after {\n  content : '';\n  position : absolute;\n  top : 0;\n  left : 0;\n  width : 100%;\n  height : 100%;\n  background : -webkit-radial-gradient(center, ellipse, rgba(182, 225, 235, 0) 0%, rgba(182, 225, 235, 0.05) 40%, rgba(182, 225, 235, 0.4) 100%);\n  background :    -moz-radial-gradient(center, ellipse, rgba(182, 225, 235, 0) 0%, rgba(182, 225, 235, 0.05) 40%, rgba(182, 225, 235, 0.4) 100%);\n  background :      -o-radial-gradient(center, ellipse, rgba(182, 225, 235, 0) 0%, rgba(182, 225, 235, 0.05) 40%, rgba(182, 225, 235, 0.4) 100%);\n  background :         radial-gradient(ellipse at center, rgba(182, 225, 235, 0) 0%, rgba(182, 225, 235, 0.05) 40%, rgba(182, 225, 235, 0.4) 100%);\n  border : 0.5px solid white;\n  border-radius : 50%;\n  opacity : 0;\n  -webkit-animation-name : k1;\n     -moz-animation-name : k1;\n       -o-animation-name : k1;\n          animation-name : k1;\n  -webkit-animation-duration : 6s;\n     -moz-animation-duration : 6s;\n       -o-animation-duration : 6s;\n          animation-duration : 6s;\n  -webkit-animation-delay : 3s;\n     -moz-animation-delay : 3s;\n       -o-animation-delay : 3s;\n          animation-delay : 3s;\n  -webkit-animation-iteration-count : infinite;\n     -moz-animation-iteration-count : infinite;\n       -o-animation-iteration-count : infinite;\n          animation-iteration-count : infinite;\n  -webkit-animation-timing-function : linear;\n     -moz-animation-timing-function : linear;\n       -o-animation-timing-function : linear;\n          animation-timing-function : linear;\n}\n  \n"])));
...
var Menu = function (_a) {
    ...
    return (React__default['default'].createElement(Wrapper, null,
        React__default['default'].createElement(PinnedBack, null,
            React__default['default'].createElement("div", { className: "bg-ripple-animation d-md-block" },
                React__default['default'].createElement("div", { className: "left-bottom-ripples" },
                    React__default['default'].createElement("div", { className: "ripples" })),
                React__default['default'].createElement("div", { className: "top-right-ripples" },
                    React__default['default'].createElement("div", { className: "ripples" })))),
        React__default['default'].createElement(StyledNav, { showMenu: showMenu },
            React__default['default'].createElement(Logo$1, { isPushed: isPushed, togglePush: function () { return setIsPushed(function (prevState) { return !prevState; }); }, isDark: isDark, href: (_b = homeLink === null || homeLink === void 0 ? void 0 : homeLink.href) !== null && _b !== void 0 ? _b : "/images/logo.png" }),
            React__default['default'].createElement(Flex, null,
                React__default['default'].createElement(CakePrice$1, { isDark: true, cakePriceUsd: cakePriceUsd }))),
        React__default['default'].createElement(BodyWrapper, null,
            React__default['default'].createElement(Panel, { isPushed: isPushed, isMobile: isMobile, showMenu: showMenu, isDark: isDark, toggleTheme: toggleTheme, langs: langs, setLang: setLang, currentLang: currentLang, cakePriceUsd: cakePriceUsd, pushNav: setIsPushed, links: links, tokenInfo: tokenInfo }),
