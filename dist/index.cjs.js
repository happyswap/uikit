...
var Logo$2 = function (_a) {
    ...
    return (React__default['default'].createElement(Flex, null,
        React__default['default'].createElement(MenuButton, { "aria-label": "Toggle menu", onClick: togglePush, mr: "0px" }, isPushed ? (React__default['default'].createElement(Icon$O, { width: "24px", color: "hamburger" })) : (React__default['default'].createElement(Icon$N, { width: "24px", color: "hamburger" }))),
        isAbsoluteUrl ? (React__default['default'].createElement(StyledLink$1, { as: "a", href: href, "aria-label": "Happyswap home page" }, innerLogo)) : (React__default['default'].createElement(StyledLink$1, { to: href, "aria-label": "Happyswap home page" }, innerLogo))));
};
...
var SubMenuContainer = styled__default['default'].div(templateObject_2$d || (templateObject_2$d = __makeTemplateObject(["\n  display: flex;\n  flex-direction: column;\n  overflow-y: auto;\n  overflow-x: hidden;\n  height: 100%;\n  margin-bottom: 1em\n"], ["\n  display: flex;\n  flex-direction: column;\n  overflow-y: auto;\n  overflow-x: hidden;\n  height: 100%;\n  margin-bottom: 1em\n"])));
var MenuA = styled__default['default'].a(templateObject_3$7 || (templateObject_3$7 = __makeTemplateObject(["\n  display: flex;\n  flex-direction: row;\n  align-items: center;\n"], ["\n  display: flex;\n  flex-direction: row;\n  align-items: center;\n"])));
...
var TokenInfo = styled__default['default'].div(templateObject_4$3 || (templateObject_4$3 = __makeTemplateObject(["\n  padding: 0 16px;\n  margin-bottom: 1px;\n  border-bottom:  ", ";\n  font-family: 'Roboto', Helvetica, Arial, sans-serif;\n  font-size: 12px;\n  font-weight: 500;\n  color: ", ";\n  background-color:  ", ";\n  .title {    \n    display: flex;\n    font-weight: 600;\n    justify-content: flex-start;\n    margin: 8px 0 10px;\n  }\n  .row{\n    display: flex;\n    justify-content: space-between;\n    margin-bottom: 10px;\n  }\n  .cap{\n    text-align: left;\n  }\n  .val {\n    text-align: right;\n  }\n  \n"], ["\n  padding: 0 16px;\n  margin-bottom: 1px;\n  border-bottom:  ", ";\n  font-family: 'Roboto', Helvetica, Arial, sans-serif;\n  font-size: 12px;\n  font-weight: 500;\n  color: ", ";\n  background-color:  ", ";\n  .title {    \n    display: flex;\n    font-weight: 600;\n    justify-content: flex-start;\n    margin: 8px 0 10px;\n  }\n  .row{\n    display: flex;\n    justify-content: space-between;\n    margin-bottom: 10px;\n  }\n  .cap{\n    text-align: left;\n  }\n  .val {\n    text-align: right;\n  }\n  \n"])), function (_a) {
    var theme = _a.theme;
...
var templateObject_1$E, templateObject_2$e, templateObject_3$8, templateObject_4$3;
...
var CakePrice = function (_a) {
    ...
    return cakePriceUsd ? (React__default['default'].createElement(PriceLink, { href: "https://dex.guru/token/0x0BbFaB36fFC86Ce9de5f5e8C27665D894508b958-bsc", target: "_blank" },
        React__default['default'].createElement(Logo$1, { className: "logo", isDark: true }),
...
var Menu = function (_a) {
    ...
    return (React__default['default'].createElement(Wrapper$1, null,
        React__default['default'].createElement(StyledNav, { showMenu: showMenu },
            React__default['default'].createElement(Logo$3, { isPushed: isPushed, togglePush: function () { return setIsPushed(function (prevState) { return !prevState; }); }, isDark: isDark, href: (_b = homeLink === null || homeLink === void 0 ? void 0 : homeLink.href) !== null && _b !== void 0 ? _b : "/images/logo.png" }),
...
var templateObject_1$H, templateObject_2$f, templateObject_3$9, templateObject_4$4, templateObject_5$1;
...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { primary: "#d8d1f6", secondary: "#fff", background: "linear-gradient(139.73deg, #8544fd 0%, #9247e2 100%)", backgroundDisabled: "#8442e2", contrast: "#EEEEEE", invertedContrast: "#262513", input: "#483F5A", inputSecondary: "#7b22e2", primaryDark: "#6527a8", tertiary: "#ffa338", text: "#fcfae2", textDisabled: "#b3a5c7", textSubtle: "#fff", borderColor: "#7d41cb", card: "#5c35fc", nav: "#5c35fc", menuBackground: "#7d41cb", menuHover: "rgba(57,31,66,0.25)", menuNavBackground: "#FFFFFF", gradients: {
